taskSevenYear.oninput = function() {
	var taskSevenYear = document.getElementById('taskSevenYear');
	var year_task7 = document.getElementById('taskSevenWriteYear');
	var len = taskSevenYear.value.trim().length;
	var year_value = parseFloat(taskSevenYear.value);
	if ((!isNaN(year_value)) && (year_value >= 1912 && year_value <= 2019)) {
		if (year_value == 1912 || year_value == 1924 || year_value == 1936 || year_value == 1948 || year_value == 1960 || year_value == 1972 || year_value == 1984 || year_value == 1996 || year_value == 2008) {
			...
			year_task7.innerHTML = 'Ваш знак зодиака по Китайскому гороскоу "Бык"';
			...
			year_task7.innerHTML = 'Ваш знак зодиака по Китайскому гороскоп "Тигр"';
			...
			year_task7.innerHTML = 'Ваш знак зодиака по Китайскому гороскоп "Змея"';
			...
			year_task7.innerHTML = 'Ваш знак зодиака по Китайскому гороскоп "Коза"';
			...
			year_task7.innerHTML = 'Ваш знак зодиака по Китайскому гороскопу "Оезьяна"';
