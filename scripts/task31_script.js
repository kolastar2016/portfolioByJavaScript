var i = 0;
var monthUA = ['Січень', 'Лютий', 'Березень', 'Квітень', 'Травень', 'Черввень', 'Липень', 'Серпень', 'Вересень', 'Жовтень', 'Листопад', 'Грудень'];            
function getDate() {
    var date = new Date();
    ...
    document.getElementById('taskThirtyoneCurrentTime').innerHTML = 'Поточний час: ' + hours + ':' + minutes + ':' + seconds;
}
...
function AddTims () {
    ...
    var tableMain = document.getElementById('taskThirtyoneMenu');
